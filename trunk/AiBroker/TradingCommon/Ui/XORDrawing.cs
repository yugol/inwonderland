...
namespace TradingCommon.Ui
{
    ...
    public class XORDrawing
    {
        ...
        public void DrawXORRectangle(Graphics grp, Point p1, Point p2)
        {
            DrawXORRectangle(grp, p1.X, p1.Y, p2.X, p2.Y);
        }

        public void DrawXORRectangle(Graphics grp, int X1, int Y1, int X2, int Y2)
        {
