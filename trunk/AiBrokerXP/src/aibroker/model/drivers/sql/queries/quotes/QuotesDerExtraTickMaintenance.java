...
public class QuotesDerExtraTickMaintenance extends MaintainQuotes {

    public QuotesDerExtraTickMaintenance(final Connection conn, final SqlSequence sequence) {
        super(conn, sequence);
    }
