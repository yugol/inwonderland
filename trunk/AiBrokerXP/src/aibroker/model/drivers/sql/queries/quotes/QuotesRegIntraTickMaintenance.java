...
public class QuotesRegIntraTickMaintenance extends MaintainQuotes {

    public QuotesRegIntraTickMaintenance(final Connection conn, final SqlSequence sequence) {
        super(conn, sequence);
    }
