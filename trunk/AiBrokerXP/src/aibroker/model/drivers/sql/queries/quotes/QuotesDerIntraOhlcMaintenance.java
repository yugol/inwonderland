...
public class QuotesDerIntraOhlcMaintenance extends MaintainQuotes {

    public QuotesDerIntraOhlcMaintenance(final Connection conn, final SqlSequence sequence) {
        super(conn, sequence);
    }
