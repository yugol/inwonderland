...
public class QuotesRegIntraOhlcMaintenance extends MaintainQuotes {

    public QuotesRegIntraOhlcMaintenance(final Connection conn, final SqlSequence sequence) {
        super(conn, sequence);
    }
