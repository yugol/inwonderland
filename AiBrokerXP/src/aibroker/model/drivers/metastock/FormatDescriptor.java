...
interface FormatDescriptor {
    ...
    int    FIELD_SIZE            = 4;       // # of bytes

    // MASTER SECTION
    String MASTER_FILE_NAME      = "MASTER";
    ...
    int    RESERVED1_0           = 5;
    int    RESERVED1_1           = 6;
    int    ISSUE_NAME_0          = 7;       // stock symbol: 16 bytes
    ...
    // MASTER SECTION
    String XMASTER_FILE_NAME     = "MASTER";
    int    XMASTER_RECORD_LENGTH = 150;     // size of a MASTER record
}
