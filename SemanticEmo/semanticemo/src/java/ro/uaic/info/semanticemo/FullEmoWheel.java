 ...
 * @author Iulian
 */
public class FullEmoWheel extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            EmoSearchEngine ese = Visible.getSearchEngine(getServletContext());
            EmoOntology emoOnt = ese.getEmoOnt();
            byte[] image = EmoUtil.generateGenericEmoMap(emoOnt);
            if (image != null) {
