...
import cogui.appli.stda.CoguiApplication;
import java.io.File;
...
public class Gui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        textFileFilter = new ro.uaic.info.wonderland.ui.TextFileFilter();
        try {
            messageProcessor = new ro.uaic.info.wonderland.engine.MessageProcessor();
        } catch (java.lang.Exception e1) {
            e1.printStackTrace();
        }
        kbFileFilter = new ro.uaic.info.wonderland.ui.KbFileFilter();
    ...
    private void showCGButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showCGButtonActionPerformed
        try {
            ...
            if (messageProcessor.getLastFile() != null) {
                ...
                setVisible(false);
                CoguiApplication.main(new String[]{});
            }
        } catch (Exception ex) {
    ...
    private void openTextFileMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_openTextFileMenuItemActionPerformed
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                String message = ro.uaic.info.wonderland.io.Utils.getFileContentAsString(file);
    ...
    private ro.uaic.info.wonderland.ui.KbFileFilter kbFileFilter;
    private javax.swing.JTabbedPane mainTabs;
    private javax.swing.JMenuBar menuBar;
    private ro.uaic.info.wonderland.engine.MessageProcessor messageProcessor;
    ...
    private ro.uaic.info.wonderland.ui.TextFileFilter textFileFilter;
